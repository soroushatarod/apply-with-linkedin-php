...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
    ...
    <table>
        ...
        <tr>
            <td style="width: 50%; text-align: left">
                E-mail: soroush.atarod@outlook.com
            </td>
        </tr>
        <tr>
            <td style="width: 50%; text-align: left">
                Contact No: 0044-7462337052
            </td>
        </tr>
        <tr>
            <td style="width: 50%; text-align: left">
...
<page pageset="old">
    ...
    <ul class="main">
        ...
        <li>&lt;code&gt;, &lt;pre&gt;</li>
        <li>&lt;div&gt; :&nbsp;
            <div style="border: solid 1px #AADDAA; background: #DDFFDD; text-align: center; width: 50mm">exemple de
                DIV
            </div>
        </li>
